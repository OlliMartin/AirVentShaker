...
public sealed partial class TransformationChain : ApiFixtureTestBase<MockedCommandExecutorApiFixture>
{
    ...
    {
        using HttpRequestMessage httpRequestMessage = ConstructCommandHttpRequestMessage(Payloads.DummyCommandNoTransformation);
    ...
    private static void AssertParserResultOneNumber(TransformationOutcome<ParserResult> response, double expectedValue)
    {
